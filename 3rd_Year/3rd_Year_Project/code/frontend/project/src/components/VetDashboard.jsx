...
import { update_vet_profile } from "../actions/profile";
...
import { update_vet_location } from "../actions/profile";
...
const VetDashboard = ({
    ...
    function success(positionData) {
        ...
        update_vet_location(latitude, longitude);
    }
    ...
    const onSubmit = e => {
        ...
        update_vet_profile(name, specialty, bio);
    };
            ...
            <Row>
                ...
                <Form onSubmit={e => onSubmit(e)}>
                    ...
                    <ButtonGroup className="d-flex mt-3">
                        <Button className="mt-3 mb-3" variant="primary" type="submit">Update Vet Profile</Button>
                        <Button className="mt-3 mb-3" variant="primary" onClick={handleLocationClick}>Update Vet Location</Button>
                    </ButtonGroup>
                </Form>
                <hr></hr>
...
export default connect(mapStateToProps, { update_vet_profile, delete_account, update_vet_location })(VetDashboard);
